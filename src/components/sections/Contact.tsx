    ...
    >
      <div className="mx-auto flex w-full max-w-3xl flex-col items-center gap-8 text-center">
        ...
        <p className="max-w-xl text-lg leading-relaxed text-muted-foreground">
          ...
          SWE, AI research, or product. Bay Area preferred.
        </p>
        <div className="mt-2 flex w-full flex-col gap-3 sm:w-auto sm:flex-row sm:flex-wrap sm:justify-center">
          <Button asChild size="lg" className="h-11 w-full px-5 text-base sm:w-auto">
            <a href="mailto:koike.d@northeastern.edu">
          ...
          >
            <a
              href="https://www.linkedin.com/in/daiki-koike-48781116b/"
              target="_blank"
          ...
          >
            <a
              href="https://github.com/Daiki007121"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <Button
            ...
            className="h-11 w-full px-5 text-base sm:w-auto"
          >
            <a href="/daiki-koike-resume.pdf" download>
